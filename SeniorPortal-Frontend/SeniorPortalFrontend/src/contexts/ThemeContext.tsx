...
// docs/architecture/senior-portal-contracts.md §5 — contrato de preferências:
// reusar EXATAMENTE as chaves `theme`/`fontSize` já usadas por
// care-web/stock-web (localStorage é por-origem, não por-caminho, então essas
// chaves passam a ser compartilhadas automaticamente entre os três apps assim
// que estiverem sob a mesma origem — nenhuma chave nova ou prefixada por app).
