// §6.4 — validador de `returnTo` pro caso cruzado (portal → care): quando o
...
// SeniorPortal-Frontend/.../utils/returnPath.ts: caminho relativo (sem `//`,
// sem esquema, sem `\`) e dentro de `/`, `/care` ou `/stock`. Sem pacote
// compartilhado ainda (design.md decisão 8) — duplicado deliberadamente, não
// divergido.
