...
public interface IAccountTokenService
{
    ...
    // Invalida tokens pendentes do mesmo propósito antes de emitir um substituto.
    Task<string> ReissueAsync(Guid userId, AccountTokenPurpose purpose, TimeSpan validity, CancellationToken cancellationToken = default);
